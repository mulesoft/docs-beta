...
For projects that are deployed on Mule 3, MuleSoft recommends that you use the Mule Migration Assistant (MMA) to save the time and effort of re-creating the application from scratch in Mule 4.
