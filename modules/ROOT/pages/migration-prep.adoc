...
For projects that are deployed on Mule 3, you can use the Mule Migration Assistant (MMA) to save the time and effort of re-creating the application from scratch in Mule 4.
...
|Runtime Fabric is Mule 4 ready.

|Anypoint Platform Private Cloud Edition (PCE)
| PCE supports Mule Runtime 4

|Anypoint Platform for Pivotal Cloud Foundry (PCF)
| PCF does not support Mule Runtime 4
|===
