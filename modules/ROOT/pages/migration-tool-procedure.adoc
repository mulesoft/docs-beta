muleVersion 4.1.5= Perform a Migration to Mule 4
...
----
$ java -jar mule-migration-assistant-runner-0.5.0.jar \
...
Whenever the MMA adds an entry to the report (ERROR, WARNING, or INO), the
