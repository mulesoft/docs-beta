...
* https://repository.mulesoft.org/nexus/service/local/repositories/releases/content/com/mulesoft/tools/mule-migration-assistant-runner/0.5.0/mule-migration-assistant-runner-0.5.0.jar[Mule Migration Assistant (Jar file)]
...
----
$ java -jar mule-migration-assistant-runner-0.5.0.jar -muleVersion 4.1.3 -projectBasePath /Users/home/AnypointStudio/workspace-studio6/querying-a-mysql-database-1.4.0-mule-application-example -destinationProjectBasePath /Users/me/Downloads/querying-a-mysql-database-mule4
----
+
...
need to append the name of the project, as shown in the example above. The `-destinationProjectBasePath` can be any local path. For details, see
...
----
$ ...
Executing migrator 0.5.0...
===============================================================================
MIGRATION ASSISTANT RUN SUCCESSFULLY
===============================================================================
Components migrated successfully:  42 %
