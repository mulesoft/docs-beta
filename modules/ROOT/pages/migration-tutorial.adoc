...
//TODO: ADD URI TO MMA WHEN AVAILABLE.
...
[[warning_1]]
== MMA Warning: Migrate HTTP Listener Components
...
[[warning_2]]
== MMA Warning: Migrate the Attributes to Inbound Properties Component
...
[[warning_3]]
== MMA Warning: Migrate Outbound Properties to var Component
...
[[warning_4]]
== MMA Info: Migrate the Global Database Connection
...
[[warning_5]]
== MMA Warning: Migrate the Database Query to Mule 4
