...
+
The app is in the *querying-a-mysql-database-mule4* project.
. View the migrated app in Studio 7.
+
image::../assets/images/mmt-migrated-app.png[Imported App]
+
All the app's components are in a single flow called *database-to-jsonFlow*.
+
...
////
REMOVING MAVEN INSTALLATION STEPS. NOT NEEDED FOR GA. 
[[maven_install]]
