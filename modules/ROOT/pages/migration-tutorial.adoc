...
----
$ java -jar mule-migration-assistant-runner-0.5.0.jar -muleVersion 4.1.5 -projectBasePath /Users/home/AnypointStudio/workspace-studio6/querying-a-mysql-database-1.4.0-mule-application-example -destinationProjectBasePath /Users/me/Downloads/querying-a-mysql-database-mule4
----
+
