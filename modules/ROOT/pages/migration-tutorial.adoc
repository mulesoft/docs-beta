...
//* MMA: https://repository.mulesoft.org/nexus/service/local/repositories/releases/content/com/mulesoft/tools/mule-migration-assistant-runner/1.0.0/mule-migration-assistant-runner-1.0.0.zip[Mule Migration Assistant (Zip file)] images::../assets/images/external-link-icon.png[external link, width=5%]
* MMA: Coming soon.
* https://www.mulesoft.com/lp/dl/studio/previous[Anypoint Studio 6] images::../assets/images/external-link-icon.png[external link, width=5%]
...
//TODO: ESTEBAN SAYS PROB NOT NEEDED BC COMPAT MODULES WILL BE AVAILABLE AT GA. TBD:
...
//TODO (MIGHT NOT BE NEEDED): If you do not know your credentials, contact your CSM. 
