...
+
. In the *Database Config* window that opens, click the *Connection* field, and change the value from *Data Source Reference Connection* to *MySQL Connection*.
+
...
setting, for example:
+
image::mmt-db-set-props.png[Database Configuration: Set Properties]
+
