...
Note that the report identifies items that remain to complete the migration to Mule 4. The
...
before the app will work. Additionally, the report will contain some INFO
messages about Mule 3 components that were removed or changed to make use of some new
features of Mule 4.
