...
//TESTING
image::../assets/images/external-link-icon.png[]
...
//* MMA: https://repository.mulesoft.org/nexus/service/local/repositories/releases/content/com/mulesoft/tools/mule-migration-assistant-runner/1.0.0/mule-migration-assistant-runner-1.0.0.zip[Mule Migration Assistant (Zip file)] image::../assets/images/external-link-icon.png[]
* MMA: Coming soon.
* https://www.mulesoft.com/lp/dl/studio/previous[Anypoint Studio 6] + 
image::image::../assets/images/external-link-icon.png[]
