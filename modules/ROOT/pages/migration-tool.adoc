...
. Perform a manual migration on what MMA could not migrate.
...
*Note* : This list can be enhanced during time adding the support of new components
...
* Any other connectors or module not mentioned before.
