...
*Important! The Compatibility module is subject to conditions for https://www.mulesoft.com/legal/versioning-back-support-policy#community[Community] connectors.*
