...
// (`<processor-chain />`)
** Processor chain scope migrates to flow reference component
// (`<remove-attachment/>`)
** Remove attachment migrates to remove variable component
// (`<set-attachment/>`)
** Set attachmeent migrates to set variable component
// (`<set-payload/>`)
