...
When MMA detects something it cannot migrate, it provides feedback about the
problem and links to information about the steps you need to take. The assistant also
comments on and provides guidance for any cases that MMA is able to migrate
without following the best practices.

Inside each migrated project, MMA generates a report that
