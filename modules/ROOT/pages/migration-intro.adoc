...
* A partially automated migration with the Mule Migration Assistant (MMA)
...
MMA is an open source project on https://github.com/mulesoft/mule-migration-assistant[GitHub]. 
